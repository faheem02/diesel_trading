                        ...
                        <?php while ($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="#" class="badge badge-primary" data-toggle="modal" data-target="#tankerModal<?= $row['id'] ?>">
                                        <i class="fas fa-truck"></i> <?= $row['tanker_count'] ?>
                                    </a>
                                    <?php if ($row['return_count'] > 0): ?>
                                        <a href="#" class="badge badge-warning" data-toggle="modal" data-target="#returnModal<?= $row['id'] ?>">
                                ...
                                <td class="text-center">
                                    <?php if ($row['invoice_attachment']): ?>
                                        <a href="../../<?= htmlspecialchars($row['invoice_attachment']) ?>" target="_blank" class="btn btn-sm btn-outline-primary">
                                ...
                                <td class="text-center">
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        <a href="adjustments.php?purchase_id=<?= $row['id'] ?>" class="btn btn-outline-info" title="Adjustment">
