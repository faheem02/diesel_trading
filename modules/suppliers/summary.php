...
if ($print_mode) {
    ...
    <div class="print-wrapper">
        ...
        <div class="party-line">
            <span class="label">Supplier:</span> <?= htmlspecialchars($supplier['company_name']) ?>
            &nbsp;&nbsp;|&nbsp;&nbsp;
            <span class="label">Contact:</span> <?= htmlspecialchars($supplier['contact_person'] ?: '-') ?>
            &nbsp;&nbsp;|&nbsp;&nbsp;
            <span class="label">Phone:</span> <?= htmlspecialchars($supplier['phone'] ?: '-') ?>
            &nbsp;&nbsp;|&nbsp;&nbsp;
            <span class="label">NTN/CNIC:</span> <?= htmlspecialchars($supplier['ntn_cnic'] ?: '-') ?>
        </div>
        ...
        <table class="summary-table">
            ...
            <tbody>
                ...
                <tr>
                    <td>Total Purchases (Credit)</td>
                    <td class="text-right text-danger"><?= number_format($total_purchases_credit, 2) ?></td>
                </tr>
                <tr>
                    <td>Total Payments Made (Debit)</td>
                    <td class="text-right text-success"><?= number_format($total_payments_debit, 2) ?></td>
                </tr>
            </tbody>
            <tfoot>
                <tr>
